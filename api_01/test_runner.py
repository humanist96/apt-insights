...
class TestRunner:
    ...
    def generate_report(self):
        ...
        # 마크다운 보고서 생성
        report_content = f"""# API 01 테스트 결과 보고서

## 테스트 정보
- **테스트 일시**: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
- **API**: 아파트 분양권전매 실거래가 자료
...
def main():
    ...
    test_cases = [
        ...
        },
        {
            ...
            'lawd_cd': '11680',
            'deal_ymd': '202312',
            'description': '강남구 분양권전매 거래 데이터 조회'
        },
        {
            'name': '강남구 2023년 11월',
            'lawd_cd': '11680',
            'deal_ymd': '202311',
            'description': '강남구 2023년 11월 데이터 조회'
        },
        {
            'name': '서초구 2023년 12월',
            'lawd_cd': '11650',
            'deal_ymd': '202312',
            'description': '서초구 분양권전매 거래 데이터 조회'
        },
        {
            'name': '송파구 2023년 12월',
            'lawd_cd': '11710',
            'deal_ymd': '202312',
            'description': '송파구 분양권전매 거래 데이터 조회'
        }
    ]
